	                            		...
	                            		<div class="col-sm-12 col-md-6 d-flex justify-content-end">
	                            			<form class="form-inline">
												<select name="type" class="custom-select custom-select-sm form-control form-control-sm mr-3">
												    ...
												    <option value="C" <c:out value="${page.cri.type eq 'C' ? 'selected' : '' }" />>본문</option>
												    <option value="W" <c:out value="${page.cri.type eq 'W' ? 'selected' : '' }" />>작성자</option>
												</select>
		                            			<div id="dataTable_filter" class="input-group">	
			                            			<input name="keyword" type="search" class="form-control form-control-sm" placeholder="search.."  value="${page.cri.keyword}">
